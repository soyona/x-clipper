...
- [x] 2026-08-13 将 X Home、作者 Posts/Articles 列表和 `/status`、`/article` 原文页的五项动态操作迁移到 `Grok actions` 左侧的独立 x-clipper 图标；原生 More 不再扩展，普通 Post 直接从当前卡片采集并按 status URL 去重。
